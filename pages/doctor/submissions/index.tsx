...
// import { getDoctorSubmissions, getPatient } from '@/utils';
...
const DoctorHomePage: NextPage<Props> = ({ submissions }) => { 
  ...
  return (
    <Layout title='Home'>
        ...
        {/* <div className="py-5 w-full h-[calc(100%-40px)]"> */}
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    // console.log("***** session")
    // console.log({session});
    const body = { doctorId: session?.user.id, status:'Pending' };
